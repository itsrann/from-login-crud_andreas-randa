    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href="https://github.com/itsrann" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/andreas_randa02" target="_blank"><i class=" bi bi-instagram fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">Andreas Randa</u></p>
    </footer>
    <!-- Close Footer -->
