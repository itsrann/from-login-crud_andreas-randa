...
<body>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="D4-Pertanian/Perkebunan">D4-Pertanian/Perkebunan</option>
                            <option value="D4-Peternekan">D4-Peternekan</option>
                        </select>
                    </div>
                    <div class="mb-3">
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://instagram.com/vikrysurya_" target="_blank" style="color: #fff;">Andreas Randa</a></p>
    </footer>
    <!-- Close Footer -->
