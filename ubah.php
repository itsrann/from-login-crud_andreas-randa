...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Rann | Crud</a>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="D4-Teknologi Rekayasa Komputer" <?php if ($siswa['jurusan'] == 'D4-Teknologi Rekayasa Komputer') { ?> selected='' <?php } ?>>D4-Teknologi Rekayasa Komputer</option>
                            <option value="D4-Pertanian/Perkebunan" <?php if ($siswa['jurusan'] == 'D4-Pertanian/Perkebunan') { ?> selected='' <?php } ?>>D4-Pertanian/Perkebunan</option>
                            <option value="D4-Peternakan" <?php if ($siswa['jurusan'] == 'D4-Peternakan') { ?> selected='' <?php } ?>>D4-Peternakan</option>
                        </select>
                    </div>
                    <div class="mb-3">
